...
int exmdbc_mailbox_commit_delayed_trans(struct exmdbc_mailbox *mbox, bool force, bool *changes_r);
...
void exmdbc_mailbox_register_untagged(struct exmdbc_mailbox *mbox, const char *name, exmdbc_mailbox_callback_t *callback);
void exmdbc_mailbox_register_resp_text(struct exmdbc_mailbox *mbox, const char *key, exmdbc_mailbox_callback_t *callback);
